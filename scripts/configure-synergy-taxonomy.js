...
export const HERO_SYNERGY_TAGS = {
    ...
    yelena_belova: ["Espías","Operaciones"],
    mbaku: ["Wakanda","Marciales"],
    red_guardian: ["Avengers","Operaciones"],
    korg: ["Asgardianos","Bestias"],
    nebula: ["Guardianes","Tecnología"],
    wong: ["Místico","Operaciones"],
    yondu: ["Guardianes","Cósmico"],
    maria_hill: ["Espías","Operaciones"],
    echo: ["Callejero","Marciales"],
    howard_the_duck: ["Guardianes","Bestias"],
    valkyrie: ["Asgardianos","Marciales"],
    rogue: ["X-Men","Mutantes"],
    beast: ["X-Men","Bestias"],
    cable: ["X-Men","Tecnología"],
    miles_morales: ["Callejero","Arácnidos"],
    sentry: ["Cósmico","Nexo Caótico"],
    x_23: ["X-Men","Mutantes"],
    beta_ray_bill: ["Asgardianos","Cósmico"],
    drax: ["Guardianes","Marciales"],
    cosmo: ["Guardianes","Bestias"],
    lady_sif: ["Asgardianos","Marciales"],
    heimdall: ["Asgardianos","Operaciones"],
    white_tiger: ["Callejero","Marciales"],
    tigra: ["Callejero","Bestias"],
    mockingbird: ["Espías","Operaciones"],
    kate_bishop: ["Avengers","Espías"],
    profesor_x: ["X-Men","Nexo Caótico"]
};
