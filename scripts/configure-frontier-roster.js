...
const heroContracts = {
    war_machine: contract('War Machine', 'Tecnológico', 'Rare', 360, 48, 175, 1.1, false, 'ARTILLERIA PESADA', 'Misiles con dano de area y penetracion parcial. 18% de quemar al objetivo principal durante 2.4 s: 14% de su dano efectivo por segundo, sin acumularse.', 'splash antiarmadura para grupos densos', ['Avengers', 'Tecnologia'], 'artillery', [5, 3, 2, 3], { projectileProfile: { splashRadius: 54, splashFactor: 0.34, armorPenetration: 0.18 }, attackEffects: [{ type: 'burn', duration: 2.4, power: 0.14, damageBasis: 'attackDamage', chance: 0.18 }], visualStyle: 'explosive', projectileColor: '#9bd1ff' }),
