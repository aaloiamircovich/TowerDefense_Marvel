...
Object.assign(enemies.bosses, {
    malekith: { id: 'malekith', name: 'Malekith', category: 'Místico', hp: 5200, speed: 32, reward: 720, armor: 0.38, isBoss: true, faction: 'Ejército de Malekith', archetype: 'boss', threat: 5, phases: [{ threshold: 0.7, label: 'Éter oscuro', speedFactor: 1.15, barrierRatio: 0.12 }, { threshold: 0.35, label: 'Convergencia', speedFactor: 1.25, summonId: 'dark_elf_skirmisher', summonCount: 3 }] },
    baron_mordo: { id: 'baron_mordo', name: 'Barón Mordo', category: 'Místico', hp: 5600, speed: 30, reward: 760, armor: 0.3, isBoss: true, faction: 'Dimensión Oscura', archetype: 'boss', threat: 5, phases: [{ threshold: 0.72, label: 'Hechizo vedado', barrierRatio: 0.18 }, { threshold: 0.38, label: 'Ruptura temporal', speedFactor: 1.3, summonId: 'dark_zealot', summonCount: 2 }] },
    sauron: { id: 'sauron', name: 'Sauron', category: 'Mutante', hp: 6100, speed: 36, reward: 800, armor: 0.32, flying: true, isBoss: true, faction: 'Savage Land', archetype: 'boss', threat: 5, phases: [{ threshold: 0.66, label: 'Drenaje vital', heal: 0.12 }, { threshold: 0.3, label: 'Señor prehistórico', speedFactor: 1.25, summonId: 'savage_raptor', summonCount: 4 }] },
    abomination: { id: 'abomination', name: 'Abominación', category: 'Mutante', hp: 7200, speed: 28, reward: 860, armor: 0.45, isBoss: true, faction: 'Prisioneros de The Raft', archetype: 'boss', threat: 5, phases: [{ threshold: 0.7, label: 'Furia gamma', speedFactor: 1.18, barrierRatio: 0.12 }, { threshold: 0.32, label: 'Contención rota', speedFactor: 1.3, summonId: 'raft_escapee', summonCount: 4 }] }
});
