...
const items = [
    ...
    item('formula_phoenix', 'FORMULA PHOENIX', '45% de quemar durante 5 s: 30% del dano efectivo del heroe por segundo, sin acumular. Area de dano y +25% contra enemigos quemados. Jean Grey evolucionada: Dark Phoenix cada 8 ataques, quema en area (36% poder/s, 5 s).', 13500, 5, 'Mythic', 'artifact', 'cosmic', { burnChance: 0.45, burnDuration: 5, burnAttackDamagePct: 0.3, damageToBurnedPct: 0.25, splashRadius: 44, splashFactor: 0.28 }),
