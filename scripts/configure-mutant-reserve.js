...
const contracts = {
    ...
    domino: { cost: 220, ability: 'SUERTE IMPOSIBLE', abilityDesc: 'Cada quinto ataque es un crítico controlado y su suerte sembrada puede desviar una brecha hacia atrás.', niche: 'criticos previsibles, economia y desvio', metrics: [4, 3, 4, 5] },
