...
const contracts = {
    ...
    blade: { cost: 330, ability: 'CAZADOR DAYWALKER', abilityDesc: 'Aplica sangrado reforzado a elites y toxina acumulable contra monstruos resistentes.', niche: 'caza de elites, sangrado y desgaste', metrics: [5, 2, 3, 4] },
