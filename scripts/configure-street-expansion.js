...
const contracts = {
    ...
    luke_cage: { cost: 210, ability: 'DEFENSOR INQUEBRANTABLE', abilityDesc: 'Protege aliados cercanos y devuelve a la ruta a enemigos que superan el ultimo tramo de la defensa.', niche: 'intercepcion de brechas y proteccion local', metrics: [3, 4, 5, 1] },
