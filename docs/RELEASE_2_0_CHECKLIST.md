...
- [x] Suite de 205 pruebas, smoke browser, balance, benchmark, accesibilidad y validacion integrados en `npm run check`.
- [x] Service worker y version publica sincronizados en 2.14.0.
