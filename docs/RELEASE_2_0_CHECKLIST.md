...
- [x] Suite de 239 pruebas, smoke browser, balance, benchmark, accesibilidad y validacion integrados en `npm run check`.
- [x] Service worker y version publica sincronizados en 2.31.0.
