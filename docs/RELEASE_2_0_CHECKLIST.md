...
- [x] Suite de 279 pruebas, smoke browser, balance, benchmark, accesibilidad y validacion integrados en `npm run check`.
- [x] Service worker y version publica sincronizados en 2.42.0.
