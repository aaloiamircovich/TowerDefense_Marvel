...
4. Revision final - EN CURSO. Recorrido completo de navegacion y acciones en
   escritorio/movil, regresiones de guardado y comprobacion en Railway.
...
Pendientes tras Radar/mapas: 1 (revision final).
