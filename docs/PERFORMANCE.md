...
`npm run check` ejecuta validacion de datos y assets, 128 tests, simulacion de balance, benchmark y control de lanzamiento. GitHub Actions reproduce el mismo comando en cada push y pull request.
