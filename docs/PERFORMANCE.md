...
`npm run check` ejecuta validación de datos y assets, 179 tests, simulación de balance, benchmark, auditoría de accesibilidad y control de lanzamiento. GitHub Actions reproduce el mismo comando en cada push y pull request.
