...
`npm run check` ejecuta validación de datos y assets, 182 tests, simulación de balance, benchmark, auditoría de accesibilidad, control de lanzamiento y smoke browser del primer minuto. GitHub Actions reproduce el mismo comando en cada push y pull request.
