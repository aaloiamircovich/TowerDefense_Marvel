...
La versión 2.5.0 puede instalarse como PWA, conserva los recursos esenciales para jugar sin conexión, migra guardados 1.x al esquema actual, suma validación browser del primer minuto de juego, mejora el slice visual inicial de Manhattan, agrega mejoras de campo rápidas, refuerza la integridad de rutas enemigas y dirige las primeras oleadas de campaña.
