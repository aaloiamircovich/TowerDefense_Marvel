...
La versión 2.2.0 puede instalarse como PWA, conserva los recursos esenciales para jugar sin conexión, migra guardados 1.x al esquema actual, suma validación browser del primer minuto de juego y mejora el slice visual inicial de Manhattan.
