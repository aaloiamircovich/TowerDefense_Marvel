...
Incluye 78 héroes con kits y sprites completos, 49 enemigos, 19 jefes, 15 agrupaciones con rarezas y requisitos variables, evoluciones reversibles, maestría, códice, cinco modos de juego, director de encuentros con afijos y ramas de botín, 38 objetos con forja, replays por semilla, mando, controles configurables y estadísticas históricas.

La version 2.44.x puede instalarse como PWA, conserva los recursos esenciales para jugar sin conexion, perfecciona la colocacion por agua, pasto y montana con afinidades por heroe y overlay de compatibilidad, agrega menu de agrupaciones con 15 grupos y buffs por composicion, usa rarezas Common/Rare/Epic/Legendary/Mythic/Secret para heroes y agrupaciones, elimina la barricada de Manhattan para dejar convoyes y alcantarillas como mecanica clara, migra guardados 1.x al esquema actual, suma validacion browser del primer minuto de juego, mejora el slice visual inicial de Manhattan, agrega mejoras de campo rapidas, refuerza la integridad de rutas enemigas, dirige las primeras oleadas de campana, aclara costes de mejora en el roster, suma lectura de amenaza por oleada, muestra intel accionable por enemigo antes de iniciar, expone cadencia de salida enemiga con ETA y peligro, muestra proximo refuerzo durante la oleada, mejora indicadores de estados enemigos, feedback visual de impacto e intencion de objetivo, agrega racha limpia en modos especiales, suma bonus de creditos por oleadas perfectas y lo anticipa antes de iniciar, expone score y razones de counter en el roster, agrega insight de tienda para objetos recomendados, muestra progreso de bonus de set antes de comprar, mide la cobertura real de ruta durante la colocacion y al seleccionar heroes desplegados, conecta el CTA de inicio con el riesgo de la oleada, agrega asesor de preparacion tactica, recomienda counters directamente en el roster, muestra preparacion recomendada accionable antes de iniciar, sugiere celdas de despliegue por cobertura real y permite confirmarlas con Enter, permite activar o desactivar texto flotante de combate, anuncia apariciones de jefes y elites con telegraph visual, muestra HUD de jefe activo con fase y salud, alerta presion de fuga durante el combate, ofrece mejora de emergencia desde esa alerta, muestra un informe tactico con calificacion post-oleada y aprendizaje, permite mejorar al MVP desde esa lectura, cambia prioridad de objetivo desde el roster desplegado y suma atajos configurables para ciclar objetivo y mejorar al heroe seleccionado.
...
- [Fases post-auditoría](docs/PLAN_FASES_POST_AUDITORIA.md)
