...
test('CampaignPanel compacta operaciones y resume desbloqueos por estrellas', () => {
    ...
    assert.match(ui.panelContent.innerHTML, /Calles de Nueva York\. Desbloqueado\. Requiere 25 estrellas/);
    assert.match(ui.panelContent.innerHTML, /Reino de Wakanda\. Bloqueado\. Requiere 50 estrellas/);
    assert.match(ui.panelContent.innerHTML, /Reino de Wakanda/);
    assert.match(ui.panelContent.innerHTML, /25 estrellas restantes/);
    ...
    assert.match(ui.panelContent.innerHTML, /aria-label="Progreso de desbloqueo 25 de 50 estrellas"/);
    assert.match(ui.panelContent.innerHTML, /aria-valuemax="50" aria-valuenow="25"/);
