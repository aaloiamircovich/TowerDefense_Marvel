const STRINGS = {
    es: {
        ...
        adminModeHint: 'Ingresa la contrasena para desbloquear todo el contenido y dinero infinito.',
        adminModeActive: 'Activo: todos los heroes, objetos, mapas, estrellas y dinero estan desbloqueados.',
    ...
    en: {
        ...
        adminModeHint: 'Enter the password to unlock all content and infinite credits.',
        adminModeActive: 'Active: all heroes, items, maps, stars, and credits are unlocked.',
