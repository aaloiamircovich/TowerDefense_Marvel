const CACHE_NAME = 'hero-td-v2.45.0-game-confirm-sprite-focus-v1-20260811';
const CORE_ASSETS = [
    './', './index.html', './styles.css', './styles.css?v=game-confirm-sprite-focus-v1-20260811', './manifest.webmanifest',
